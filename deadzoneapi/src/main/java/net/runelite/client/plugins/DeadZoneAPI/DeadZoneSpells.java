...
public enum DeadZoneSpells
{
	...
	@Nullable
	public static WidgetInfo AB1CaddDEdaHI12361JKLM8NO3ka5gw(final String spell)
	{
	...
	public WidgetInfo DEFGvsdHI1sfggwPQRSTUdfVop2qrstuz178()
	{
		return this.widgetInfo;
	}

	DeadZoneSpells(final String name, final WidgetInfo info)
	{
		this.spellName = name;
	...
	static
	{
		...
		for (final DeadZoneSpells spells : values())
		{
			builder.put(spells.AB1CaddDEdaHI12361JKLM8NO3ka5gw(), spells.DEFGvsdHI1sfggwPQRSTUdfVop2qrstuz178());
		}
